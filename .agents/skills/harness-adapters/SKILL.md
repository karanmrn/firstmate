...
description: >-
  ...
  Contains verified facts for claude, codex, opencode, pi, pi-signed, grok, kimi, cursor, muse, and prime.
...
Muse and Prime are verified only for crewmate and scout work, never a secondmate or primary.
...
Kimi establishes its unsupported primary boundary in its selected harness reference; Muse and Prime follow Non-negotiable safety above.
...
```json harness-adapter-routing-v1
{
  ...
  "harnesses": {
    ...
    "prime": "references/harness/prime.md"
  }
}
```
