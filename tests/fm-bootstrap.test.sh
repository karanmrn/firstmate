...
prime shared efforts are accepted^{"rules":[{"when":"prime low","use":{"harness":"prime","model":"openrouter/moonshotai/kimi-k2.6","effort":"low"}},{"when":"prime max","use":{"harness":"prime","effort":"max"}}]}^empty^
unsupported prime minimal effort is flagged^{"rules":[{"when":"prime minimal","use":{"harness":"prime","effort":"minimal"}}]}^exact^CREW_DISPATCH: invalid config/crew-dispatch.json - invalid effort: prime:minimal
